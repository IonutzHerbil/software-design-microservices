...
const MOVIE_DB = {
  101: {
    ...
    title: "Dune: Part Two",
    description:
      "Paul Atreides unites with the Fremen on Arrakis to wage war against House Harkonnen.",
  },
  102: {
    id: 102,
    title: "Oppenheimer",
    description:
      "The story of J. Robert Oppenheimer and the invention of the atomic bomb.",
  },
  103: {
    id: 103,
    title: "Poor Things",
    description:
      "The fantastical evolution of Bella Baxter, brought back to life by a brilliant scientist.",
  },
  104: {
    id: 104,
  ...
  105: {
    ...
    title: "Past Lives",
    description:
      "Two childhood sweethearts are separated, then reunite in New York decades later.",
  },
  106: {
    id: 106,
    title: "The Zone of Interest",
    description:
      "The commandant of Auschwitz and his wife build a life right beside the camp.",
  },
  107: {
    id: 107,
    title: "Saltburn",
    description:
      "A student becomes fascinated by his charming classmate and enters his aristocratic world.",
  },
  108: {
    id: 108,
    title: "American Fiction",
    description:
      "A novelist frustrated by racial stereotypes in publishing writes a parody that becomes a bestseller.",
  },
};
...
const FALLBACK_MOVIES = [
  ...
  },
  {
    ...
    description:
      "Batman raises the stakes in his war on crime with the emergence of the Joker.",
  },
  {
    id: 3,
    title: "Interstellar",
  ...
  },
  {
    ...
    title: "Pulp Fiction",
    description:
      "The lives of two mob hitmen, a boxer, and a pair of bandits intertwine in four tales.",
  },
  {
    id: 5,
    title: "The Matrix",
    description:
      "A programmer discovers that reality is a simulation and joins a rebellion against its controllers.",
  },
];
